...
var svg2png_1 = require("../svg2png");
function svg2pngCli(o) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    files = typeof o.input === 'string' ? glob_1.sync(o.input).filter(fs_1.existsSync) : [o.input];
                    input = files.length ? files
                        .filter(function (f) { return fs_1.statSync(f).isFile(); })
                        .map(function (f) { return ({
                        name: typeof f === 'string' ? f : 'input.svg',
                        content: typeof f === 'string' ? fs_1.readFileSync(f) : f
                    }); }) : [{
                            name: 'input.svg',
                            content: typeof o.input === 'string' ? buffer_1.BufferClass.from(o.input) : o.input
                        }];
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        _a = { name: input.name + '.' + (o.format || 'png') };
                                        return [4 /*yield*/, svg2png_1.svg2png(__assign({}, o, { input: input.content }))];
                                    case 1:
...
//# sourceMappingURL=svg2pngCli.js.map