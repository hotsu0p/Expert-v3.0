...
export interface PNG2SVGOptions extends BaseOptions, RemoveProperties<PotracePosterizeOptions, 'optCurve'>, RemoveProperties<ImageTraceOptions, 'input'> {
    /**
...
export declare enum Potrace {
    COLOR_AUTO = "auto",
    COLOR_TRANSPARENT = "transparent",
    THRESHOLD_AUTO = -1
}
export declare enum Posterizer {
    STEPS_AUTO = -1
}
export declare enum PotraceRangeDistributionPolicy {
    RANGES_AUTO = "auto",
    RANGES_EQUAL = "equal"
}
export declare enum PotraceFillPolicy {
    FILL_SPREAD = "spread",
...
export declare enum PotraceTurnPolicy {
...
export declare type Format = 'svg' | OutputFormat;
export declare type OutputFormat = 'png' | 'jpeg';
export declare type Encoding = 'base64' | 'dataURL' | 'raw' | 'buffer';
import { Bitmap2VectorOptions as ImageTraceOptions } from 'bitmap2vector';
